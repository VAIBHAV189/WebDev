//-------------------------------------------------------------------//
//If we take 500 promises and we dont resolve them then it will cause memory leak
...
function compressFile(file_name)
{
    return new Promise(function(resolve,reject)
    {
        if(-1 == ['mp4','flv','webm'].indexOf(file_name.split('.').pop())) 
            throw new Error('We can only compress video files');
...
//Execution of promise and resolving it
// let p=new Promise(function download(url)
// {
//     return new Promise(function(resolve,reject)
//     {
//         console.log("Download starts");
